					      		...
					      		<form id="Pay" action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_top">
    									...
    									<div class="input-group">
    									  ...
    									  <span class="input-group-btn">
    								        <button type="image" class="btn btn-primary btn-large" name="submit" alt="PayPal - The safer, easier way to pay online!" onclick="$('#Pay').submit()">Pay Now</button>
    								      </span>
    									</div>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="well well-small">
              <p>
                We prefer cash or check made payable to Capital City Pet Care, but we also accept payments through our secure invoicing service or they can be made securely through PayPal via the "Pay Now" button above.
              </p>
            </div>
          </div>
        </div>
