        ...
        <div class="col-xs-12 real-content">
          <div class="row">
            <div class="col-xs-12 separator">
              <a class="anchor" id="consultations"></a>
              <div class="mask"></div>
              <span><i><h2>Consultations</h2></i></span>
            </div>
          </div>
          <div class="row">
          ...
          <div class="row">
            <div class="col-xs-12 separator">
              <a class="anchor" id="vacation-visits"></a>
              <div class="mask"></div>
          ...
          <div class="row">
            <div class="col-xs-12 separator">
              <a class="anchor" id="dog-walking"></a>
              <div class="mask"></div>
              <span><i><h2>Midday Dog Walking</h2></i></span>
            </div>
          </div>
          <div class="row">
              <div class="col-md-10 col-md-offset-1">
          ...
          <div class="row">
            <div class="col-xs-12 separator">
              ...
              <div class="mask"></div>
              <span><i><h2>Add-on Services</h2></i></span>
            </div>
          </div>
          <div class="row">
              <div class="col-md-10 col-md-offset-1">
